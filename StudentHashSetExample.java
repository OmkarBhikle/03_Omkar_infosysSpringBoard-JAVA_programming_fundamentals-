...
public class StudentHashSetExample {
    ...
    public static void main(String[] args) {
        ...
        Student student1 = new Student("Harshal", 101);
        Student student2 = new Student("Aditya", 102);
        Student student3 = new Student("Yash", 101); // Duplicate rollNumber with student1
